...
// from https://rosettacode.org/wiki/Barnsley_fern#Java
// tmpx and tmpy are temporary fields

import javax.swing.*;
import java.awt.*;
import java.awt.image.BufferedImage;

public class BarnsleyFernTwo extends JPanel {

    BufferedImage img;
    double tmpx, tmpy;  // temporary fields

    public BarnsleyFernTwo() {
        final int dim = 640;
